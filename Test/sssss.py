...
access_key="4ruU7ayu0r%2BGctDhbc6L3IruWayh2oiaMDsR%2Fo8iuhpo2qZTPwKyhrKj1EvfIMqssGehRSCfQlQw4uO%2BR6bSXg%3D%3D" #본인의 access_key를 입력하세요.
...
def make_d2_dir(dir_num):
    os.mkdir('.' + dir_delimeter + repo_base_name + dir_delimeter + depth_level2_dir + str(dir_num))
...
# 나머지 parameters 변수를 추가하는 코드를 작성하세요.
